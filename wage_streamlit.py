...
# ============================================================
st.header("74. 都道府県別一人当たり平均賃金を日本地図にヒートマップ表示するための準備", divider="gray")
...
# ============================================================
st.header("75. 都道府県別一人当たり平均賃金を日本地図にヒートマップ表示", divider="gray")
...
# ============================================================
# 76. 集計年別の一人当たり平均賃金の推移をグラフ表示
# ============================================================
st.header("76. 集計年別の一人当たり平均賃金の推移をグラフ表示", divider="gray")
...
# 77. バブルチャートとは
# ============================================================
st.header("77. バブルチャートとは", divider="gray")

# ============================================================
# 78. 年齢階級別の全国一人当たり平均賃金をバブルチャート表示
# ============================================================
st.header("78. 年齢階級別の全国一人当たり平均賃金をバブルチャート表示", divider="gray")
...
# 79. 産業別の平均賃金を横棒グラフ表示
# ============================================================
st.header("79. 産業別の平均賃金を横棒グラフ表示", divider="gray")
